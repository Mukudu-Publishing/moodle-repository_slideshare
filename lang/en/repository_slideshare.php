...
$string['configplugin'] = 'Config for the Slideshare repository';
$string['pluginname_help'] = 'A Slideshare search repository';
...
$string['apikeyprompt_help'] = 'Enter the key you have been issued by Slideshare.';
$string['apisecretprompt'] = 'Enter Shared Secret Key';
$string['filesperpageprompt'] = 'Default results per page.';
